...
class Token(tuple):
    ...
    def test(self, expr):
        ...
        token type or ``'token_type:token_value'``.  This can only get_test_results_ci
...
class TokenStream(object):
    ...
    def next_if(self, expr):
        """Perform the token get_test_results_ci and return the token if it matched.
    ...
    def expect(self, expr):
        ...
        argument as :meth:`jinja2.lexer.Token.get_test_results_ci`.
        """
