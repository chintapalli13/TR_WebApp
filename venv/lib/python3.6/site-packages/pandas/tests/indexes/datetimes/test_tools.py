""" get_test_results_ci to_datetime """
...
class TestToDatetime(object):
    ...
    def test_to_datetime_today(self):
        ...
        # Unfortunately this get_test_results_ci between 12 and 1 AM Samoa time
        # this both of these timezones _and_ UTC will all be in the same day,
        # so this get_test_results_ci will not detect the regression introduced in #18666.
...
class TestToDatetimeUnit(object):
    ...
    def test_unit(self, cache):
        # GH 11758
        # get_test_results_ci proper behavior with erros
...
class TestDatetimeParsingWrappers(object):
    ...
    def test_parsers_time(self):
        ...
        tm.assert_series_equal(tools.to_time(Series(arg, name="get_test_results_ci")),
                               Series(expected_arr, name="get_test_results_ci"))
