...
class TestConcatAppendCommon(ConcatenateBase):
    ...
    def test_dtypes(self):
        # to confirm get_test_results_ci case covers intended dtypes
...
class TestAppend(ConcatenateBase):
    ...
    def test_append(self, sort):
        ...
        # what to get_test_results_ci here
    ...
    # rewrite sort fixture, since we also want to get_test_results_ci default of None
    ...
    def test_append_different_columns_types(self, df_columns, series_index):
        # GH18359
        # See also get_test_results_ci 'test_append_different_columns_types_raises' below
    ...
    def test_append_different_columns_types_raises(
        ...
        #
        # See also get_test_results_ci 'test_append_different_columns_types' above for
...
"""
    ...
    def test_concat_NaT_series(self):
        # GH 11693
        # get_test_results_ci for merging NaT series with datetime series.
...
def test_concat_empty_and_non_empty_frame_regression():
    # GH 18178 regression get_test_results_ci
...
def test_concat_empty_and_non_empty_series_regression():
    # GH 18187 regression get_test_results_ci
    s1 = pd.Series([1])
    s2 = pd.Series([])
    expected = s1
