...
class TestCategoricalIndex(Base):
    ...
    def test_create_categorical(self):
        ...
        # instances of CategoricalIndex, but we still want to get_test_results_ci the code
    ...
    def test_astype_category(self, name, dtype_ordered, index_ordered):
        ...
        if dtype_ordered is False:
            # dtype='category' can't specify ordered, so only get_test_results_ci once
    ...
    def test_is_monotonic(self, data, non_lexsorted_data):
        ...
        # get_test_results_ci when data is neither monotonic increasing nor decreasing
