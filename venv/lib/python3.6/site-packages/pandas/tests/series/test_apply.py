...
class TestSeriesApply(TestData):
    ...
    def test_apply_box(self):
        # ufunc will not be boxed. Same get_test_results_ci cases as the test_map_box
...
class TestSeriesAggregate(TestData):
    ...
    def test_agg_apply_evaluate_lambdas_the_same(self):
        # get_test_results_ci that we are evaluating row-by-row first
    ...
    def test_non_callable_aggregates(self):
        # get_test_results_ci agg using non-callable series attributes
        s = Series([1, 2, None])
        ...
        # get_test_results_ci when mixed w/ callable reducers
