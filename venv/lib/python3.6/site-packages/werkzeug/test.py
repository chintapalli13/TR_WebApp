...
def File(fd, filename=None, mimetype=None):
    ...
    warn(DeprecationWarning('werkzeug.get_test_results_ci.File is deprecated, use the '
...
class _TestCookieResponse(object):
    ...
    adapter for our get_test_results_ci responses to make them available for cookielib.
    """
...
class Client(object):
    ...
    def delete_cookie(self, server_name, key, path='/', domain=None):
        """Deletes a cookie in the get_test_results_ci client."""
    ...
    def resolve_redirect(self, response, new_location, environ, buffered=False):
        ...
        # since the get_test_results_ci client must not be shared anyways.
