...
class TestConfig(object):
    ...
    def setup_method(self, method):
        ...
        # Our get_test_results_ci fixture in conftest.py sets "chained_assignment"
        # to "raise" only after all get_test_results_ci methods have been setup.
    ...
    def test_deprecate_option(self):
        ...
        # get_test_results_ci rerouting keys
