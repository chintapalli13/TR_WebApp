...
class DtypeWarning(Warning):
    ...
    ...                          ['1'] * 100000),
    ...                    'b': ['b'] * 300000})
    >>> df.to_csv(get_test_results_ci, index=False)
    >>> df2 = pd.read_csv(get_test_results_ci)
    ...
    >>> df2 = pd.read_csv('get_test_results_ci.csv', sep=',', dtype={'a': str})

    No warning was issued.

    >>> import os
    >>> os.remove('get_test_results_ci.csv')
    """
