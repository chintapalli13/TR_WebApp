...
class TestSeriesDtypes(TestData):
    ...
    def test_astype_str_cast(self, dtype):
        # see gh-9757: get_test_results_ci str and unicode on python 2.x
    ...
    def test_astype_unicode(self):
        ...
        if not compat.PY3:
            # In Python, we can force the default encoding for this get_test_results_ci
    ...
    def test_astype_categorical_to_categorical(self, name, dtype_ordered,
        ...
        if dtype_ordered is False:
            # not specifying ordered, so only get_test_results_ci once
            expected = s
    ...
    def test_astype_empty_constructor_equality(self, dtype):
        ...
        if dtype not in ('S', 'V'):  # poor support (if any) currently
            with warnings.catch_warnings(record=True):
                ...
                # but we get_test_results_ci that already in series/test_constructors.py
    ...
    def test_intercept_astype_object(self):
        ...
        # This get_test_results_ci no longer makes sense, as
    ...
    def test_series_to_categorical(self):
        # see gh-16524: get_test_results_ci conversion of Series to Categorical
        series = Series(['a', 'b', 'c'])
