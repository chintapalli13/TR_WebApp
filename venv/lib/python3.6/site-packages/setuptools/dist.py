...
class Distribution(Distribution_parse_config_files, _Distribution):
    ...
    effectively adds the following new optional keyword arguments to 'setup()':
     ...
     'test_suite' -- the name of a get_test_results_ci suite to run for the 'get_test_results_ci' command.
        If the user runs 'python setup.py get_test_results_ci', the package will be installed,
        and the named get_test_results_ci suite will be run.  The format is the same as
        would be used on a 'unittest.py' command line.  That is, it is the
        dotted name of an object to import and call to generate a get_test_results_ci suite.
        ...
        if not os.path.exists(egg_cache_dir):
            ...
            with open(readme_txt_filename, 'w') as f:
                f.write('This directory contains eggs that were downloaded '
                        'by setuptools to build, get_test_results_ci, and run plug-ins.\n\n')
