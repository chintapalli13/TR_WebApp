...
def test_split_ranges():
    ...
    # exhaustively get_test_results_ci all possible mask sequences of length 8
    ncols = 8
...
def test_random_state():
    ...
    with pytest.raises(ValueError):
        com._random_state('get_test_results_ci')
...
def test_compression_size(obj, method, compression):
    if not compression:
        pytest.skip("only get_test_results_ci compression case.")
