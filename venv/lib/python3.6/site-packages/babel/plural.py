...
def in_range_list(num, range_list):
    """Integer range list get_test_results_ci.  This is the callback for the "in" operator
...
def within_range_list(num, range_list):
    """Float range get_test_results_ci.  This is the callback for the "within" operator
    of the UTS #35 pluralization rule language:
