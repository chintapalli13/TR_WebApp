"""Base get_test_results_ci suite for extension arrays.
...
* The same module as your get_test_results_ci class.
* A ``conftest.py`` in the same directory as your get_test_results_ci class.
...
wherever the get_test_results_ci requires it. You're free to implement additional tests.
...
``assert_series_equal`` on your base get_test_results_ci class.
