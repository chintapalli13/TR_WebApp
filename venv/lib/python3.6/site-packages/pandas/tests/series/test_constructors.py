...
class TestSeriesConstructors(TestData):
    ...
    def test_constructor_categorical_with_coercion(self):
        ...
        # get_test_results_ci basic creation / coercion of categoricals
    ...
    def test_constructor_index_mismatch(self, input):
        # GH 19342
        # get_test_results_ci that construction of a Series with an index of different length
        # raises an error
    ...
    def test_constructor_copy(self):
        # GH15125
        # get_test_results_ci dtype parameter has no side effects on copy=True
    ...
    def test_constructor_limit_copies(self, index):
        ...
        # we make 1 copy; this is just a smoke get_test_results_ci here
    ...
    def test_constructor_cant_cast_datetimelike(self, index):
        ...
        # ints are ok
        # we get_test_results_ci with np.int64 to get similar results on
