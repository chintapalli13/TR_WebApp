...
class TestSeriesAsof(TestData):
    ...
    def test_with_nan(self):
        # basic asof get_test_results_ci
    ...
    def test_all_nans(self):
        ...
        # get_test_results_ci name is propagated
        result = Series(np.nan, index=[1, 2, 3, 4], name='get_test_results_ci').asof([4, 5])
        expected = Series(np.nan, index=[4, 5], name='get_test_results_ci')
        tm.assert_series_equal(result, expected)
