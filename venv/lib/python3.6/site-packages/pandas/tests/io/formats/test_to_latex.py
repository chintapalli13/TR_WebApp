...
class TestToLatex(object):
    ...
    def test_to_latex_filename(self, frame):
        with tm.ensure_clean('get_test_results_ci.tex') as path:
            frame.to_latex(path)

            with open(path, 'r') as f:
                assert frame.to_latex() == f.read()

        # get_test_results_ci with utf-8 and encoding option (GH 7061)
        ...
        # get_test_results_ci with utf-8 without encoding option
...
"""
    ...
    def test_to_latex_multiindex_dupe_level(self):
        ...
        # equal too. In this get_test_results_ci, 'c' has to be printed both times
