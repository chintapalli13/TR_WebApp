...
get_test_results_ci suite is independent of the others because the
...
"""
    ...
    def test_BytesIO_input(self):
        if not compat.PY3:
            pytest.skip(
                "Bytes-related get_test_results_ci - only needs to work on Python 3")
...
1421302964.226776    PRI=6 PGN=0xf002               SRC=0x47    243 00 00 255 247 00 00 71"""  # noqa
    ...
    def test_fwf_compression(self):
        try:
            ...
            pytest.skip("Need gzip and bz2 to run this get_test_results_ci")
