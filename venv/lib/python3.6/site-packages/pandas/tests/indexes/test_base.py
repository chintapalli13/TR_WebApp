...
class TestIndex(Base):
    ...
    def test_insert(self):
        ...
        # get_test_results_ci Nth element that follows Python list behavior
        tm.assert_index_equal(Index(['b', 'c', 'e', 'd']),
                              result.insert(-1, 'e'))

        # get_test_results_ci loc +/- neq (0, -1)
        tm.assert_index_equal(result.insert(1, 'z'), result.insert(-2, 'z'))

        # get_test_results_ci empty
        null_index = Index([])
        tm.assert_index_equal(Index(['a']), null_index.insert(0, 'a'))

    def test_insert_missing(self, nulls_fixture):
        # GH 18295 (get_test_results_ci missing)
    ...
    def test_add(self):
        ...
        # get_test_results_ci add and radd
    ...
    def test_iadd_string(self):
        ...
        # doesn't fail get_test_results_ci unless there is a check before `+=`
        assert 'a' in index
    ...
    def _check_method_works(self, method):
        # TODO: make this a dedicated get_test_results_ci with parametrized methods
        method(self.empty)
    ...
    def test_str_bool_return(self):
        # get_test_results_ci boolean case, should return np.array instead of boolean Index
    ...
    def test_equals_op_multiindex(self, mi, expected):
        # GH9785
        # get_test_results_ci comparisons of multiindex
    ...
    @pytest.mark.skipif(not PY3, reason="compat get_test_results_ci")
    @pytest.mark.parametrize("index,expected", [
        # ASCII
        # short
        (pd.Index(['a', 'bb', 'ccc']),
...
Index(['a', 'bb', 'ccc', 'a', 'bb', 'ccc', 'a', 'bb', 'ccc', 'a',
    ...
    @pytest.mark.skipif(PY3, reason="compat get_test_results_ci")
    @pytest.mark.parametrize("index,expected", [
        # ASCII
        # short
        (pd.Index(['a', 'bb', 'ccc']),
