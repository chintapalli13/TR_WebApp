...
class TestSeriesRepr(TestData):
    ...
    def test_name_printing(self):
        ...
        s.name = "get_test_results_ci"
        assert "Name: get_test_results_ci" in repr(s)
        ...
        s = Series(index=date_range('20010101', '20020101'), name='get_test_results_ci')
        assert "Name: get_test_results_ci" in repr(s)
