...
class TestMultiIndexBasic(object):
    ...
    def test_iloc_getitem_multiindex2(self):
        # TODO(wesm): fix this
        pytest.skip('this get_test_results_ci was being suppressed, '
                    'needs to be fixed')
    ...
    def test_multiindex_contains_dropped(self):
        # GH 19027
        # get_test_results_ci that dropped MultiIndex levels are not in the MultiIndex
...
class TestMultiIndexSlicers(object):
    ...
    def test_per_axis_per_level_getitem(self):
        ...
        # GH6134
        # example get_test_results_ci case
        ...
        # get_test_results_ci multi-index slicing with per axis and per index controls
    ...
    def test_per_axis_per_level_doc_examples(self):
        ...
        # get_test_results_ci index maker
        idx = pd.IndexSlice
