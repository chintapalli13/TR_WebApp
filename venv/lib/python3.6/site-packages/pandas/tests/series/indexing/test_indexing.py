...
""" get_test_results_ci get/set & misc """
...
def test_getitem_setitem_integers():
    # caused bug without get_test_results_ci
...
def test_type_promote_putmask():
    # GH8387: get_test_results_ci that changing types does not break alignment
...
def test_setitem_scalar_into_readonly_backing_data():
    # GH14359: get_test_results_ci that you cannot mutate a read only buffer
