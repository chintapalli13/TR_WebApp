...
class Base(object):
    ...
    def setup_method(self, method):
        ...
        # create get_test_results_ci series object
...
x   q   30      3    -0.6662 -0.5243 -0.3580  0.89145  2.5838"""
    ...
    def test_unstack(self):
        ...
        # get_test_results_ci that ints work
        self.ymd.astype(int).unstack()

        # get_test_results_ci that int32 work
...
class TestSorted(Base):
    """ everything you wanted to get_test_results_ci about sorting """
