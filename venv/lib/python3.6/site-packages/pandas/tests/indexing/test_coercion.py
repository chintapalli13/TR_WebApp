...
def check_comprehensiveness(request):
    ...
    # and ensure that each are contained within a collected get_test_results_ci
    cls = request.cls
    ...
    for combo in combos:
        if not has_test(combo):
            msg = 'get_test_results_ci method is not defined: {0}, {1}'
...
class TestSetitemCoercion(CoercionBase):
    ...
    def _assert_setitem_series_conversion(self, original_series, loc_value,
        ...
        """ get_test_results_ci series value's coercion triggered by assignment """
    ...
    def _assert_setitem_index_conversion(self, original_series, loc_key,
        ...
        """ get_test_results_ci index's coercion triggered by assign key """
        temp = original_series.copy()
        temp[loc_key] = 5
...
class TestInsertIndexCoercion(CoercionBase):
    ...
    def _assert_insert_conversion(self, original, value,
        ...
        """ get_test_results_ci coercion triggered by insert """
...
class TestWhereCoercion(CoercionBase):
    ...
    def _assert_where_conversion(self, original, cond, values,
                                 expected, expected_dtype):
        """ get_test_results_ci coercion triggered by where """
        target = original.copy()
...
class TestFillnaSeriesCoercion(CoercionBase):
    ...
    def _assert_fillna_conversion(self, original, value,
                                  expected, expected_dtype):
        """ get_test_results_ci coercion triggered by fillna """
        target = original.copy()
...
class TestReplaceSeriesCoercion(CoercionBase):
    ...
    for tz in ['UTC', 'US/Eastern']:
        # to get_test_results_ci tz => different tz replacement
