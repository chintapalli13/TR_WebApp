...
class TestStata(object):
    ...
    def test_read_dta2(self):
        ...
        # buggy get_test_results_ci because of the NaT comparison on certain platforms
        # Format 113 get_test_results_ci fails since it does not support tc and tC formats
    ...
    def test_date_parsing_ignores_format_details(self, column):
        ...
        #
        # STATA supports 9 date types which each have distinct units. We get_test_results_ci 7
