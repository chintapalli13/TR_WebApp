...
def left_df(request, df1):
    """ Construct left get_test_results_ci DataFrame with specified levels
...
def right_df(request, df2):
    """ Construct right get_test_results_ci DataFrame with specified levels
...
def compute_expected(df_left, df_right,
    ...
    """
    Compute the expected merge result for the get_test_results_ci case.
