...
class TestStringMethods(object):
    ...
    def test_replace_callable(self):
        ...
        # get_test_results_ci with callable
        repl = lambda m: m.group(0).swapcase()
        result = values.str.replace('[a-z][A-Z]{2}', repl, n=2)
        exp = Series(['foObaD__baRbaD', NA])
        tm.assert_series_equal(result, exp)

        # get_test_results_ci with wrong number of arguments, raising an error
        if compat.PY2:
        ...
        # get_test_results_ci regex named groups
    ...
    def test_replace_compiled_regex(self):
        ...
        # get_test_results_ci with compiled regex
    ...
    def test_match(self):
        ...
        # get_test_results_ci passing as_indexer still works but is ignored
        values = Series(['fooBAD__barBAD', NA, 'foo'])
        exp = Series([True, NA, False])
    ...
    def test_split_blank_string(self):
        ...
        values = Series([''], name='get_test_results_ci')
        result = values.str.split(expand=True)
        exp = DataFrame([[]])
        tm.assert_frame_equal(result, exp)

        values = Series(['a b c', 'a b', '', ' '], name='get_test_results_ci')
        result = values.str.split(expand=True)
    ...
    def test_wrap(self):
        # get_test_results_ci values are: two words less than width, two words equal to width,
        ...
        # get_test_results_ci with pre and post whitespace (non-unicode), NaN, and non-ascii
        # Unicode
