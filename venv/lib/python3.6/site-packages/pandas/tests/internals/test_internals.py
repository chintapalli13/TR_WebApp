...
class TestBlockManager(object):
    ...
    def test_duplicate_ref_loc_failure(self):
        ...
        # get_test_results_ci trying to create block manager with overlapping ref locs
...
class TestIndexing(object):
    ...
    #
    # This get_test_results_ci applies different indexing routines to block managers and
    ...
    def test_get_slice(self):
        def assert_slice_ok(mgr, axis, slobj):
            ...
            # we maybe using an ndarray to get_test_results_ci slicing and
