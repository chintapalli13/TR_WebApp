...
class TestStyler(object):
    ...
    def test_numeric_columns(self):
        ...
        # smoke get_test_results_ci for _translate
    ...
    def test_unique_id(self):
        ...
        result = df.style.render(uuid='get_test_results_ci')
        assert 'get_test_results_ci' in result
    ...
    def test_hide_columns_single_level(self):
        # GH 14194
        # get_test_results_ci hiding single column
        ctx = self.df.style._translate()
        ...
        # get_test_results_ci hiding mulitiple columns
