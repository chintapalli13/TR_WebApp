...
class TestResampleAPI(object):
    ...
    # `Base` get_test_results_ci class
    def test_agg(self):
        # get_test_results_ci with all three Resampler apis and TimeGrouper
...
class Base(object):
    ...
    def test_asfreq_fill_value(self):
        # get_test_results_ci for fill value during resampling, issue 3715
    ...
    def test_resample_empty_series(self):
        ...
        for freq in ['M', 'D', 'H']:
            # need to get_test_results_ci for ohlc from GH13083
    ...
    def test_resample_empty_dataframe(self):
        ...
        for freq in ['M', 'D', 'H']:
            ...
            # get_test_results_ci size for GH13212 (currently stays as df)
...
11-08-2014,00:00:21.191,1"""
    ...
    def test_corner_cases(self):
        # miscellaneous get_test_results_ci coverage
    ...
    def test_resample_across_dst(self):
        # The get_test_results_ci resamples a DatetimeIndex with values before and after a
        # DST change
        # Issue: 14682
