...
class Base(object):
    ...
    def test_shift(self):
        ...
        # GH8083 get_test_results_ci the base class for shift
        idx = self.create_index()
    ...
    def test_ndarray_compat_properties(self):
        ...
        # get_test_results_ci for validity
        idx.nbytes
        idx.values.nbytes
    ...
    def test_str(self):
        ...
        # get_test_results_ci the string repr
        idx = self.create_index()
        idx.name = 'foo'
    ...
    def test_unique(self, indices):
        # don't get_test_results_ci a MultiIndex here (as its tested separated)
        # don't get_test_results_ci a CategoricalIndex because categories change (GH 18291)
    ...
    def test_get_unique_index(self, indices):
        ...
        # We get_test_results_ci against `idx_unique`, so first we make sure it's unique
    ...
    def test_insert_base(self):
        ...
        for name, idx in compat.iteritems(self.indices):
            ...
            # get_test_results_ci 0th element
    ...
    def test_equals(self):
        ...
        for name, idx in compat.iteritems(self.indices):
            ...
            if idx.nlevels == 1:
                # do not get_test_results_ci MultiIndex
    ...
    def test_equals_op(self):
        ...
        # get_test_results_ci comparisons with numpy arrays
        ...
        # get_test_results_ci comparisons with Series
    ...
    def test_numpy_ufuncs(self):
        # get_test_results_ci ufuncs of numpy 1.9.2. see:
    ...
    def test_nulls(self):
        # this is really a smoke get_test_results_ci for the methods
    ...
    def test_searchsorted_monotonic(self, indices):
        ...
        # nothing to get_test_results_ci if the index is empty
        if indices.empty:
            return
        value = indices[0]
        ...
        # get_test_results_ci _searchsorted_monotonic in all cases
        # get_test_results_ci searchsorted only for increasing
    ...
    def test_astype_category(self, copy, name, ordered):
        ...
        if ordered is False:
            # dtype='category' defaults to ordered=False, so only get_test_results_ci once
