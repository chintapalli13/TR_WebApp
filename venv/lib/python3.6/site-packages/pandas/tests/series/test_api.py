...
class TestSeriesMisc(TestData, SharedWithSparse):
    ...
    def test_tab_completion_with_categorical(self):
        # get_test_results_ci the tab completion display
    ...
    def test_ndarray_compat(self):
        ...
        # get_test_results_ci numpy compat with Series as sub-class of NDFrame
...
class TestCategoricalSeries(object):
    ...
    def test_categorical_delegations(self):
        ...
        # This method is likely to be confused, so get_test_results_ci that it raises an error
        # on wrong inputs:
        def f():
