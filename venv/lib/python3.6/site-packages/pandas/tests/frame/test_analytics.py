...
class TestDataFrameAnalytics(TestData):
    ...
    def test_mean_corner(self):
        # unit get_test_results_ci when have object data
    ...
    def test_round(self):
        ...
        # Here's the get_test_results_ci frame we'll be working with
    ...
    def test_matmul(self):
        # matmul get_test_results_ci is for GH #10259
        a = DataFrame(np.random.randn(3, 4), index=['a', 'b', 'c'],
                      columns=['p', 'q', 'r', 's'])
        b = DataFrame(np.random.randn(4, 2), index=['p', 'q', 'r', 's'],
                      columns=['one', 'two'])
...
class TestNLargestNSmallest(object):
    ...
    def test_series_broadcasting(self):
        # smoke get_test_results_ci for numpy warnings
        # GH 16378, GH 16306
