""" get_test_results_ci parquet compat """
...
def check_round_trip(df, engine=None, path=None,
    ...
    repeat: int, optional
        How many times to repeat the get_test_results_ci
    """
...
class TestParquetPyArrow(Base):
    ...
    def test_s3_roundtrip(self, df_compat, s3_resource, pa):
        ...
        check_round_trip(df_compat, pa,
                         path='s3://pandas-get_test_results_ci/pyarrow.parquet')
...
class TestParquetFastParquet(Base):
    ...
    def test_s3_roundtrip(self, df_compat, s3_resource, fp):
        ...
        check_round_trip(df_compat, fp,
                         path='s3://pandas-get_test_results_ci/fastparquet.parquet')
